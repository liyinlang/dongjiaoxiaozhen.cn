function watermark(settings) {
        ...
        var defaultSettings = {
            ...
            watermark_width: 480, //水印宽度
            watermark_height: 360, //水印长度
        ...
        for (var i = 0; i < defaultSettings.watermark_rows; i++) {
            y = defaultSettings.watermark_y + (defaultSettings.watermark_y_space + defaultSettings.watermark_height) *
                i;
		...
		conta.style.position = 'fixed';
		conta.style.left = 0;
		conta.style.top = 0;
		conta.style.bottom = 0;
		conta.style.right =  0;
		conta.style['z-index'] =  -1;
		conta.appendChild(oTemp);
